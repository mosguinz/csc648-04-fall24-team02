...
export class ResourcesService {
  ...
  public static setResources(
    data: ResourcesData["SetResources"],
  ): CancelablePromise<Array<ResourceBase>> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/resources/",
...
export class FacilitiesService {
   ...
   * @throws ApiError
   */
  public static readMiners(): CancelablePromise<Array<UserMiner>> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static setMiners(
    data: FacilitiesData["SetMiners"],
  ): CancelablePromise<Array<UserMiner>> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/facilities/miner",
   ...
   * @throws ApiError
   */
  public static updateMiners(
    data: FacilitiesData["UpdateMiners"],
  ): CancelablePromise<Array<UserMiner>> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: "PATCH",
   ...
   * @throws ApiError
   */
  public static readAssemblers(): CancelablePromise<Array<UserAssembler>> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static setAssemblers(
    data: FacilitiesData["SetAssemblers"],
  ): CancelablePromise<Array<UserAssembler>> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/facilities/assembler",
   ...
   * @throws ApiError
   */
  public static updateAssemblers(
    data: FacilitiesData["UpdateAssemblers"],
  ): CancelablePromise<Array<UserAssembler>> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: "PATCH",
   ...
   * @throws ApiError
   */
  public static readConstructors(): CancelablePromise<Array<UserConstructor>> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static setConstructors(
    data: FacilitiesData["SetConstructors"],
  ): CancelablePromise<Array<UserConstructor>> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/facilities/constructor",
   ...
   * @throws ApiError
   */
  public static updateConstructors(
    data: FacilitiesData["UpdateConstructors"],
  ): CancelablePromise<Array<UserConstructor>> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: "PATCH",
