...
export default class MainMenu extends Phaser.Scene {
	...
	private smelterTimers: { [key: string]: Phaser.Time.TimerEvent } = {}
	...
	editorCreate(): void {
		...
		// create an inventory instance to access inventory methods
	...
	// Function for floating text for smelters.
