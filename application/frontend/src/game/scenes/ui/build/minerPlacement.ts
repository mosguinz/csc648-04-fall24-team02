  ...
  create() {
    this.add
      .nineslice(
        ...
        "inventory_panel",
        0,
        this.MINER_PLACEMENT_WIDTH,
        this.MINER_PLACEMENT_HEIGHT,
        NSP,
        NSP,
        NSP,
        NSP,
    ...
    const placementContainer = this.add.container(
      GAME_WIDTH / 2 - this.MINER_PLACEMENT_WIDTH / 2,
      0,
    );
    ...
    placementContainer.add(
      this.add
        .text(
          this.MINER_PLACEMENT_WIDTH / 2,
          this.MINER_PLACEMENT_HEIGHT / 7,
          "HARVESTING?",
          TEXT_STYLE,
        )
        .setOrigin(0.5, 0.5)
    ...
    const closeButton = this.add
      .image(this.MINER_PLACEMENT_WIDTH - 35, 35, "close_button")
      .setOrigin(0.5, 0.5)
      .setScale(3)
      .setInteractive();
    ...
    // Harvest item 1
    const harvestItem1 = this.add
      .image(
        this.MINER_PLACEMENT_WIDTH / 4,
        this.MINER_PLACEMENT_HEIGHT / 2,
        "1",
      )
      .setOrigin(0.5, 0.5)
      .setScale(4)
    ...
    // Harvest item 3
    const harvestItem3 = this.add
      .image(
        (this.MINER_PLACEMENT_WIDTH * 3) / 4,
        this.MINER_PLACEMENT_HEIGHT / 2,
        "3",
      )
      .setOrigin(0.5, 0.5)
